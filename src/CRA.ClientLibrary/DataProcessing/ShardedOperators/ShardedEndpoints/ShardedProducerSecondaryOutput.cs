...
{
    public class ShardedProducerSecondaryOutput : ShardedOperatorOutputBase
    {
        private ShardedProducerOperator _vertex;

        public ShardedProducerSecondaryOutput(IVertex vertex, int shardId, int numOtherOperatorShards, string endpointName) : base(shardId, numOtherOperatorShards, endpointName)
        {
