            ...
            if (Encoding.ASCII.GetString(_deployMsgBuffer).Equals("DEPLOY"))
            {
                ...
                if (Encoding.ASCII.GetString(_runMsgBuffer).Equals("RUN"))
                {
                    ...
                    MethodInfo generic = method.MakeGenericMethod(
                            new Type[] { _vertex._task.OperationTypes.OutputKeyType, _vertex._task.OperationTypes.OutputPayloadType,
                                         _vertex._task.OperationTypes.OutputDatasetType });
                    generic.Invoke(this, new Object[] { _vertex._cachedDatasets[_shardId][_vertex._task.InputIds.InputId1], stream });
                }
            }
        }
    }
